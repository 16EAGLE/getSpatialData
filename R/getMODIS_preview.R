...
#' @param record data.frame, single row data.frame collected from the return of \link{getMODIS_records}, representing the selected record and all its attributes.
...
#'
#' @seealso \link{getMODIS_names} \link{getMODIS_records} \link{getMODIS_data}
#' @export
