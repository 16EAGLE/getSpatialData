...
For all public functions [documentation is available](https://jxsw.de/getSpatialData). See also the [list of data sources](http://github.com/16EAGLE/getSpatialData#) that are or will be implemented.
