...
vars.sentinel <- data.frame(platforms = c("Sentinel-1", "Sentinel-2", "Sentinel-3", "Sentinel-5P"),
                            ...
                            user = c(test.cred$dhus.user, test.cred$dhus.user, test.cred$s3.user, test.cred$s5p.user),
                            pass = c(test.cred$dhus.pass, test.cred$dhus.pass, test.cred$s3.pass, test.cred$s5p.pass))
